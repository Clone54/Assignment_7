...
export default function FriendCard({ friend }) {
  ...
  return (
    <Link
      to={`/friend/${friend.id}`}
      className="bg-white rounded-[32px] border border-[#F2F2F2] w-[260px] w-full pt-8 pb-6 px-4 shadow-sm hover:shadow-xl transition-all flex flex-col items-center"
    >
